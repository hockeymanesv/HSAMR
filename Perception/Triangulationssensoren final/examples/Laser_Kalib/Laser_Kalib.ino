...
#define lasercurrent 2.9925             //Laserdiodenstartstrom in mAma
...
//Bakside             (an A0-Backside)
float poly0[] = {-31.847,286.32,-1006.6,1762.3,-1618.2,737.11}; 
//Backsensor        (an A1-Back)
float poly1[] = {-41.606,359.65,-1204.9,1985,-1692.5,717.77};
//Frontsidesensor   (an A2-FrontSide)
float poly2[] = {-50.562,427.88,-1407.8,2289.7,-1933.1,795.54};
//Front            (an A3-FONT)
float poly3[] = {-19.36,181.92,-683.64,1307.7,-1330.4,665.21};
