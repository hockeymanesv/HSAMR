...
public class NavigationAT implements INavigation {
    ...
    static final double FRONT_SENSOR_OFFSET = 0.086;
    static final double FRONT_SIDE_SENSOR_OFFSET = 0.075;
    static final double BACK_SENSOR_OFFSET = 0;
    static final double BACK_SIDE_SENSOR_OFFSET = 0.075;
    
    static final double FRONT_SENSOR_OFFAXIS = 0.001;
    static final double FRONT_SIDE_SENSOR_OFFAXIS = 0.042;
    static final double BACK_SIDE_SENSOR_OFFAXIS = -0.092;
    ...
    private void calculateLocation() {
        ...
        if(Math.abs(xResult - 1.4) < 0.15 && Math.abs(yResult) < 0.15){
            if(angleResult > aMax){
                aMax = angleResult;
        ...
        if(Math.abs(xResult-0.9) < 0.30 && Math.abs(yResult- 0.3) < 0.1){
        ...
        if(Math.abs(xResult- 1.65) < 0.1 && Math.abs(yResult) < 0.1 && angleOverwrite){
        ...
        if(Math.abs(xResult - 0.45) < 0.10 && Math.abs(yResult-0.3) < 0.15 && angleOverwrite){
            Sound.beepSequenceUp();
